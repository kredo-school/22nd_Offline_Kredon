...
class FaqSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $faqs = [
            ...
            [
                'category_slug' => 'insurance',
                'question' => 'キャッシュレス受診するために必要な書類はなんですか？',
                'question_en' => 'What documents are required for a cashless visit?',
                'answer' => "1. 海外旅行保険の保険証券（コピー可）\n2. パスポート（コピー可）\n3. 日本出国日が確認できる書類（Eチケットやスタンプ等）\n4. クレジット付帯保険をお持ちの場合は、必ず事前にカード会社にご連絡ください。",
                'answer_en' => "1. Travel insurance certificate (copy accepted)\n2. Passport (copy accepted)\n3. Proof of departure from Japan (e-ticket, passport stamp, etc.)\n4. If you have credit card supplemental insurance, please contact your card issuer in advance.",
                'is_active' => true,
                'sort_order' => 3,
            ],
            [
                ...
                'answer' => "日本語スタッフが受付・通訳・受診・お薬の受け取りまでサポートするサービスです。\n※キャッシュレス受診の可否は、ご加入の保険内容によって異なります。",

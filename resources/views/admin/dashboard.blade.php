                    ...
                    <div class="col">
                        ...
                        <div class="card h-100 p-3 border" style="border-color: #3B82F6 !important;">
                            ...
                            <div class="d-flex align-items-center gap-1 mt-1">
                                <span class="chg {{ $userGrowthRate >= 0 ? 'up' : 'down' }}">
                                    <i
                                        class="ti ti-arrow-{{ $userGrowthRate >= 0 ? 'up' : 'down' }}"></i>{{ $userGrowthRate >= 0 ? '+' : '' }}{{ $userGrowthRate }}%
                                </span>
                            ...
                            <div class="chart-wrap">
                                <svg class="line-chart" viewBox="0 0 400 120" preserveAspectRatio="none">
                                    <line x1="0" y1="110" x2="400" y2="110" stroke="#E5E7EB"
                                        stroke-width="0.5" />
                                    <line x1="0" y1="78" x2="400" y2="78" stroke="#E5E7EB"
                                        stroke-width="0.5" stroke-dasharray="4,4" />
                                    <line x1="0" y1="46" x2="400" y2="46" stroke="#E5E7EB"
                                        stroke-width="0.5" stroke-dasharray="4,4" />
                                    <line x1="0" y1="14" x2="400" y2="14" stroke="#E5E7EB"
                                        stroke-width="0.5" stroke-dasharray="4,4" />
                            ...
                            <div class="d-flex flex-column gap-2">
                                ...
                                <div>
                                    ...
                                    <div class="cat-bar-bg">
                                        <div class="cat-bar-fill" style="width:38%;background:#3B82F6;"></div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="cat-bar-bg">
                                        <div class="cat-bar-fill" style="width:27%;background:#8B5CF6;"></div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="cat-bar-bg">
                                        <div class="cat-bar-fill" style="width:19%;background:#10B981;"></div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="cat-bar-bg">
                                        <div class="cat-bar-fill" style="width:10%;background:#F59E0B;"></div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="cat-bar-bg">
                                        <div class="cat-bar-fill" style="width:6%;background:#EF4444;"></div>
                                    </div>
                                </div>

    ...
    <div class="p-4" style="overflow-y: auto; height: 100%;">
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-12 col-sm-6 col-xl-3">
                <div class="card h-100 border-0 shadow-sm p-3">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <small class="text-muted d-block mb-1" style="font-size: 0.75rem;">Active Urgent
                                Alerts</small>
        ...
        <ul class="nav nav-tabs mb-3" id="notificationTabs" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link {{ $activeTab === 'list' ? 'active' : '' }}" id="tab-list-btn"
        ...
        <div class="tab-content" id="notificationTabsContent">
            ...
            {{-- ============ TAB 1: LIST ============ --}}
            <div class="tab-pane fade {{ $activeTab === 'list' ? 'show active' : '' }}" id="tab-list"
                role="tabpanel">
                                    ...
                                    <table class="table table-hover align-middle mb-0" style="font-size:0.82rem;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <span class="badge bg-light text-dark border px-2 py-1"><i
                                                            class="fa-solid fa-bolt text-warning me-1"></i>
                                                        Instant</span>
                                                </td>
                                                <td class="text-center">
                                                    <span class="badge rounded-pill bg-success px-2 py-1"
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>
                                                    <div class="text-dark"><strong>User@User</strong> replied to
                                                        MikeB's
                                                        comment.</div>
                                                    <div class="text-muted text-truncate"
                                                        style="font-size:0.72rem; max-width: 350px;">
...
<div class="tab-pane fade {{ $activeTab === 'create' ? 'show active' : '' }}" id="tab-create"
    role="tabpanel">
    <form id="notificationCreateForm" method="POST"
            ...
            <div class="col-12 col-lg-7">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold" style="font-size:0.8rem;">Notification Title</label>
                            <input type="text" class="form-control" id="createTitleInput" name="title"
                                value="{{ old('title') }}"
                                placeholder="e.g. Summer Festival 2026 announcement">
                            @error('title')
                                <p class="text-danger mb-0 mt-1" style="font-size:0.75rem;">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="createTypeSelect" name="category">
                                ...
                                <option value="comment" {{ old('category') == 'comment' ? 'selected' : '' }}>Comment</option>
                                <option value="reply" {{ old('category') == 'reply' ? 'selected' : '' }}>Reply</option>
                                <option value="like" {{ old('category') == 'like' ? 'selected' : '' }}>Like</option>
                                <option value="event" {{ old('category') == 'event' ? 'selected' : '' }}>Event</option>
                                <option value="item_alert" {{ old('category') == 'item_alert' ? 'selected' : '' }}>Item Alert</option>
                                <option value="digest" {{ old('category') == 'digest' ? 'selected' : '' }}>Digest</option>
                            </select>
                            @error('category')
                                <p class="text-danger mb-0 mt-1" style="font-size:0.75rem;">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="createBodyInput" name="body" rows="4"
                                placeholder="Enter the notification body.">{{ old('body') }}</textarea>
                            @error('body')
                                <p class="text-danger mb-0 mt-1" style="font-size:0.75rem;">{{ $message }}</p>
                            @enderror
                        </div>
            ...
            <div class="col-12 col-lg-5">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="createTargetSelect" name="target_type">
                                ...
                                <option value="subscriber" {{ old('target_type') == 'subscriber' ? 'selected' : '' }}>Subsc-member (Premium)</option>
                                <option value="custom" {{ old('target_type') == 'custom' ? 'selected' : '' }}>Custom</option>
                            </select>
                            @error('target_type')
                                <p class="text-danger mb-0 mt-1" style="font-size:0.75rem;">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold" style="font-size:0.8rem;">Delivery Date/Time</label>
                        ...
                        <div class="form-check form-switch mb-0">
                            <input class="form-check-input" type="checkbox" role="switch" id="emailToggle"
                                name="send_email" value="1" {{ old('send_email') ? 'checked' : '' }}>
                            <label class="form-check-label" for="emailToggle" style="font-size:0.85rem;">Also send
                                email</label>
                        </div>
                    </div>
                </div>

                {{-- Link to Event は将来Eventモデルと連携。今は保留扱いのためnameなし --}}
                <div class="card border-0 shadow-sm mb-3">
                    <div class="card-body p-4">
                ...
                <div class="d-flex gap-2">
                    ...
                    <button type="submit" class="btn btn-primary flex-fill"
                        onclick="document.getElementById('formActionInput').value='schedule';">Schedule Delivery</button>
                </div>
            </div>
        </div>
    </form>
            ...
            <div class="tab-pane fade {{ $activeTab === 'templates' ? 'show active' : '' }}" id="tab-templates"
                ...
                @forelse ($templates as $tpl)
                    <div class="card border-0 shadow-sm mb-3 notif-template-card" role="button"
                        data-bs-toggle="modal" data-bs-target="#templatePreviewModal" data-id="{{ $tpl->id }}"
                        data-category="{{ $tpl->category }}" data-type="{{ $tpl->type }}"
                        data-title="{{ $tpl->title }}" data-body="{{ $tpl->body }}"
                        data-target-type="{{ $tpl->target_type }}" data-meta="Target: {{ $tpl->target_type }}">

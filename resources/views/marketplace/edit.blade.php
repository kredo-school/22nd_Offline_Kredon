            ...
            <div class="col-lg-8">
                ...
                <div class="card shadow border-0">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('marketplace.update', $item) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select name="location_name" class="form-select">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="{{ route('marketplace.show', $item->id) }}" class="btn btn-secondary">

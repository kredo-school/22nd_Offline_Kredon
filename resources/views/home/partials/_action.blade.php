<nav class="hp-action-menu">
    ...
    <a href="{{ route('top') }}" class="hp-menu-btn hp-spot">
        <i class="fa-solid fa-location-dot"></i>
        <span class="hp-menu-title">Spot</span>
        <span class="hp-menu-subtitle">Places & Services</span>
    </a>
    ...
    <a href="{{ route('game.home') }}" class="hp-menu-btn hp-game">
        <i class="fa-solid fa-gamepad"></i>
        <span class="hp-menu-title">Game</span>

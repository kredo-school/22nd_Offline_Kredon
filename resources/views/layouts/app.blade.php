<!doctype html>
    ...
    <body>
        ...
        ══════════════════════════════════ --}}
            <nav
                class="navbar navbar-expand-md navbar-light bg-white border-bottom navbar-top shadow-sm d-none d-md-flex">
                    ...
                    <ul class="navbar-nav ms-auto align-items-center flex-row gap-3">
                        ...
                        @auth
                            <li class="nav-item d-flex align-items-center">
                                <div class="vr" style="height:28px;opacity:0.5;"></div>
                            </li>
                            <li class="nav-item dropdown">
                                <a href="#" class="nav-link d-flex align-items-center gap-2" data-bs-toggle="dropdown"
                                    aria-expanded="false" id="userMenuBtnPC">
                                    @if (Auth::user()->avatarUrl())
                                        <img src="{{ Auth::user()->avatarUrl() }}" alt="avatar"
                                            style="width:32px;height:32px;border-radius:50%;object-fit:cover;">
                                    @else
                                        <span
                                            style="display:inline-flex;align-items:center;justify-content:center; width:32px;height:32px;border-radius:50%;background:#212529; color:#fff;font-size:0.8rem;font-weight:bold;">
                                            {{ strtoupper(substr(Auth::user()->name, 0, 1)) }}
                                        </span>
                                    @endif
                                    <span class="fw-semibold" style="font-size:0.85rem;color:#333;">
                                        {{ Auth::user()->name }}
                                    </span>
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    @if (Auth::user()->role === 1)
                                        <li><a class="dropdown-item fw-bold" href="{{ route('admin.dashboard') }}"
                                                style="color: darkcyan;"><i
                                                    class="fa-solid fa-shield-halved me-2"></i>Admin Page</a></li>
                                        <li>
                                            <hr class="dropdown-divider">
                                        </li>
                                    @endif
            ...
            <div class="spot-modal" id="spotModal">
                ...
                <a href="{{ route('top') }}" class="spot-modal-item"><i class="fa-solid fa-briefcase"></i>
                    Working</a>
                <a href="{{ route('healthcare.index') }}" class="spot-modal-item"><i
                        class="fa-solid fa-hospital"></i> Hospital</a>
                <a href="{{ route('tourist_spots.index') }}" class="spot-modal-item"><i
                        class="fa-solid fa-camera"></i> Tourism</a>

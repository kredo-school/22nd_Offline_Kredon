...
<head>
    ...
    <style>
        ...
        @media (min-width: 768px) {
            ...
            /* スマホ専用要素をPC時は非表示 */
            .mobile-drawer, .drawer-overlay, .hamburger-btn { display: none !important; }
        }
        ...
        <div class="py-3">
            ...
            <div class="command">
                ...
                <div id="spotSubmenu" style="display:none;" class="ps-2">
                    <a href="#" class="d-block text-decoration-none text-muted py-2 ps-5" style="font-size:0.82rem;">Working</a>
                    <a href="#" class="d-block text-decoration-none text-muted py-2 ps-5" style="font-size:0.82rem;">Hospital</a>
                    <a href="#" class="d-block text-decoration-none text-muted py-2 ps-5" style="font-size:0.82rem;">Tourism</a>
                </div>
                ...
                <a href="{{ route('reviews.index') }}" class="sidebar-link"><i class="fa-regular fa-star"></i> REVIEW</a>

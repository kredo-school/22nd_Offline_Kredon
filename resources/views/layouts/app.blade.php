                    ...
                    @auth
                        ...
                        @if (Auth::user()->role === 1)
                            <li><a class="dropdown-item fw-bold" href="{{ route('admin.dashboard') }}"
                                    style="color: darkcyan;"><i class="fa-solid fa-shield-halved me-2"></i>Admin Page</a>
                            </li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                ...
                <div class="mobile-topbar-icons">
                    ...
                    @auth
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item" href="#"><i class="fa-solid fa-gear me-2"></i>Setting</a>
                                </li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                @if (Auth::user()->role === 1)
                                    <li><a class="dropdown-item fw-bold" href="{{ route('admin.dashboard') }}"
                                            style="color: darkcyan;"><i class="fa-solid fa-shield-halved me-2"></i>Admin
                                            Page</a></li>
                                @endif
                                <li>
                                    <hr class="dropdown-divider">

    ...
    <div id="app">
                ...
                <div class="collapse navbar-collapse flex-grow-0" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto align-items-center">
                        <li class="nav-item me-3">
                            <a class="nav-link position-relative" href="{{ url('/') }}"><i class="fa-solid fa-house-chimney fa-lg"></i></a>
                        </li>
                        <li class="nav-item me-3">
                            <a class="nav-link position-relative" href="#">
                                <i class="fa-solid fa-bell fa-lg"></i>
                                <span class="position-absolute top-1 start-100 translate-middle badge rounded-pill bg-danger">2</span>
                            </a>
                        </li>
                        <li class="nav-item me-3">
        ...
        <div class="main-wrapper">
            <aside class="sidebar-left d-none d-md-block">
                <div class="py-2">
                    <a class="navbar-brand fw-bold text-primary m-0 p-0 d-block text-center" href="{{ url('/') }}" style="margin: -30px !important;">
                        <img src="{{ asset('images/kredon.png') }}" alt="Logo" style="height: 140px; width: auto; object-fit: contain;">
                    </a>
                    ...
                    <div class="command">
                        ...
                        <div id="spotSubmenu" style="display:none;" class="accordion-item">
                            <a href="#" class="d-block text-decoration-none text-muted py-2 ps-5" style="font-size:0.82rem; color: #6c757d; transition: background 0.2s;">Working</a>
                            <a href="#" class="d-block text-decoration-none text-muted py-2 ps-5" style="font-size:0.82rem; color: #6c757d; transition: background 0.2s;">Hospital</a>
                            <a href="#" class="d-block text-decoration-none text-muted py-2 ps-5" style="font-size:0.82rem; color: #6c757d; transition: background 0.2s;">Tourism</a>
                        </div>

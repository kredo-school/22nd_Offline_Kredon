...
<body>
    <div id="app">
        {{-- Desktop Topbar --}}
        <nav
            class="navbar navbar-expand-md navbar-light bg-white border-bottom navbar-top sticky-top shadow-sm d-none d-md-flex">
                    ...
                    @else
                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="nav-link dropdown-toggle d-flex align-items-center gap-2" href="#"
                                ...
                                @else
                                    <span
                                        style="display: inline-flex; align-items: center; justify-content: center; width: 32px; height: 32px; border-radius: 50%; background-color: #212529; color: #fff; font-size: 0.8rem; font-weight: bold; flex-shrink: 0;">
        ...
        {{-- スマホ用 Topbar --}}
        <nav
            class="navbar-top bg-white border-bottom shadow-sm d-flex d-md-none align-items-center px-3 justify-content-between">
            <a href="{{ url('/home') }}">
                <img src="{{ asset('images/kredon.png') }}" alt="Kredon" style="height: 40px;">
            </a>
            <div class="d-flex align-items-center gap-3">
                <a href="#" class="position-relative text-dark" data-bs-toggle="modal"
                ...
                @auth
                    <a href="#" class="d-flex align-items-center text-dark" data-bs-toggle="dropdown">
                        ...
                        @else
                            <span
                                style="display:inline-flex;align-items:center;justify-content:center;width:30px;height:30px;border-radius:50%;background:#212529;color:#fff;font-size:0.75rem;font-weight:bold;">
                                {{ strtoupper(substr(Auth::user()->name, 0, 1)) }}
                            </span>
                        @endif
                    </a>
                ...
                <div class="py-2">
                    ...
                    <div class="command mt-3">
                        ...
                        <div id="spotSubmenu" style="display:none;" class="accordion-item">
                            <a href="{{ url('/') }}" class="d-block text-decoration-none text-muted py-2 ps-5"
                                style="font-size:0.82rem; color: #6c757d;">Working</a>
                            <a href="{{ url('/healthcare') }}" class="d-block text-decoration-none text-muted py-2 ps-5" style="font-size:0.82rem; color: #6c757d;">Hospital</a>
                            <a href="{{ url('/tourist') }}" class="d-block text-decoration-none text-muted py-2 ps-5"
                                style="font-size:0.82rem; color: #6c757d;">Tourism</a>
                        </div>
                        ...
                        @auth
                            <a href="{{ route('mypage') }}" class="sidebar-link"><i class="fa-regular fa-bookmark"></i>
                                BOOKMARK</a>
                            <a href="{{ route('mypage') }}" class="sidebar-link"><i class="fa-regular fa-star"></i>
                                REVIEW</a>
                            <hr class="mx-3 my-2 text-muted">
                            <a href="{{ route('mypage') }}" class="sidebar-link"><i class="fa-regular fa-user"></i> MY
                                PAGE</a>
                        ...
                        <div class="card shadow-sm" style="background-color: rgb(218, 238, 246); border-radius: 12px;">
                            <div class="card-body p-3">
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <h6 class="card-title fw-bold m-0" style="color: darkcyan; font-size: 1.4;">KREDON
                                        PREMIUM</h6>
                                </div>

...
<img src="{{ asset('images/stage-select-normal.png') }}"
     alt="Stage Select">
...
<!-- Stage 1-1 -->
<a href="{{ route('game.stage2-1') }}"
   class="stage-link stage11">
</a>

<!-- Stage 1-2 -->
<a href="{{ route('game.stage2-2') }}"
   class="stage-link stage12">
</a>

<!-- Stage 1-3 -->
<a href="{{ route('game.stage2-3') }}"
   class="stage-link stage13">
</a>

<!-- Boss -->
<a href="{{ route('game.stage2-boss') }}"

...
@section('title','Stage ONI Battle')
...
<div class="battle-screen">
    <img src="{{ asset('images/battle-stageoni.png') }}" class="battle-bg">
    ...
    <div class="enemy-box">
        <div class="name">ENDON</div>
        <div class="hp-bar"><div id="enemyHp" class="hp"></div></div>
        <div class="hp-text">HP : <span id="enemyValue">150</span>/150</div>
    </div>
...
<script>
    ...
    window.answer = function(index) {
        ...
        if (index === q.answer) {
            ...
            document.getElementById("result").innerHTML = "Wrong! Damage -25";
        }
